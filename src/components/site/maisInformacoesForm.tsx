...
export default function MaisInformacoesForm({
  codigoImovel,
  codigoCorretor,
}: MaisInformacoesFormProps) {
  ...
  const baseInput =
    "w-full bg-transparent outline-none border-0 focus:ring-0 placeholder:text-[#9aa2b1] text-base text-gray-900";
  const cell = "p-4 sm:p-2";
  const label =
    "block text-[11px] font-semibold tracking-wide text-][#303030] uppercase mb-1";

  return (
    <form
      onSubmit={handleSubmit(onSubmit)}
      className="text-sm lead"
      id="formulario_mais_informacoes"
    >
