  ...
  return (
    <div className="bg-white md:hidden fixed left-0 z-50 bottom-0 w-full p-2">
      <div className="flex justify-around w-full gap-1 pb-2 pl-[50px]">
        ...
        <button
          onClick={() => scrollToSection("agendarVisita")}
          className="w-full text-white appearance-none inline-flex gap-1 items-center justify-center px-2 py-0 text-sm leading-4 whitespace-nowrap rounded-full cursor-pointer h-12 tracking-normal font-medium normal-case bg-site-primary hover:bg-site-primary-hover transition-colors ease-in-out duration-500"
        >
          Agendar Visita
        </button>
        <button
