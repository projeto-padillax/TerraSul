...
NewForProps) {
  ...
  return (
    <div className={`flex flex-col mt-2 justify-self-center gap-3 rounded-2xl p-4 sm:p-5 lg:p-8 w-full lg:max-w-[460px] mx-auto ${className}`}>
      <Button
        onClick={() => abrirModal("whatsapp")}
        className="bg-[#505050] cursor-pointer h-11 justify-center gap-x-2 has-[>svg]:p-5 rounded-xl"
      >
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 32 32"
          className="opacity-90 w-[20px] h-[20px] sm:w-[20px] sm:h-[20px]"
        >
          {/* Moldura externa */}
          <rect
            x="1.5"
          ...
          {/* Símbolos — agora maiores e com sombra mais forte */}
          <text
            x="8"
            y="12"
            textAnchor="middle"
